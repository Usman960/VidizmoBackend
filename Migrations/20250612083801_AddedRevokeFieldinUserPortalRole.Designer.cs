...
namespace VidizmoBackend.Migrations
{
    ...
    [Migration("20250612083801_AddedRevokeFieldinUserPortalRole")]
    partial class AddedRevokeFieldinUserPortalRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VidizmoBackend.Models.Portal", b =>
                {
                    b.Property<int>("PortalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VidizmoBackend.Models.UserPortalRole", b =>
                {
                    b.Property<int>("UserPortalRoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserPortalRoleId"));
            ...
            modelBuilder.Entity("VidizmoBackend.Models.Group", b =>
                {
                    ...
                    b.HasOne("VidizmoBackend.Models.Portal", "Portal")
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("VidizmoBackend.Models.Video", b =>
                {
                    b.HasOne("VidizmoBackend.Models.Portal", null)
                        .WithMany("Videos")
                        .HasForeignKey("PortalId");
